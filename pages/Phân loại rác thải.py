...
class WasteClassifier:
    def __init__(self, model_path=r'pages\modelTrash\best_model.h5', class_indices_path=r'pages\modelTrash\class_indices.npy'):
...
if __name__ == '__main__':
    ...
    classifier = WasteClassifier(model_path=r'pages\modelTrash\best_model.h5', class_indices_path=r'pages\modelTrash\class_indices.npy')
